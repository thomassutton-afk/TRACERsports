...
NFL_COLORS = [
    ...
    # --- Indianapolis Colts ---
    ("nfl_0013", 1996, "#001489", "#FFFFFF", None),
    ("nfl_0013", 2002, "#012169", "#FFFFFF", None),
    # --- Jacksonville Jaguars ---
    ("nfl_0014", 1996, "#00677F", "#101820", "#B58500"),
    ("nfl_0014", 2002, "#006271", "#010101", "#9A7611"),
    # --- Kansas City Chiefs ---
    ("nfl_0015", 1996, "#C8102E", "#FFB81C", "#FFFFFF"),
    ("nfl_0015", 2002, "#A6192E", "#FFB81C", "#FFFFFF"),
    # --- Miami Dolphins ---
    ("nfl_0016", 1996, "#005F61", "#FF6720", "#FFFFFF"),
    ("nfl_0016", 1997, "#005F61", "#FC4C02", "#0C2340"),
    ("nfl_0016", 2013, "#008C95", "#FF8200", "#005776"),
    # --- Minnesota Vikings ---
    ("nfl_0017", 1996, "#512D6D", "#FFB81C", "#FFFFFF"),
    ("nfl_0017", 2002, "#330072", "#FFB81C", "#FFFFFF"),
    ("nfl_0017", 2010, "#582C83", "#FFB81C", "#FFFFFF"),
    # --- New England Patriots ---
    ("nfl_0018", 1996, "#012169", "#C8102E", "#A2AAAD"),
    # --- New Orleans Saints ---
    ("nfl_0019", 1996, "#B3A369", "#101820", "#FFFFFF"),
    ("nfl_0019", 2002, "#B9975B", "#010101", "#FFFFFF"),
    # --- New York Giants ---
    ("nfl_0020", 1996, "#003087", "#C8102E", "#FFFFFF"),
    # --- New York Jets ---
    ("nfl_0021", 1996, "#046A38", "#101820", "#FFFFFF"),
    ("nfl_0021", 1998, "#285C4D", "#FFFFFF", None),
    ("nfl_0021", 2002, "#183029", "#FFFFFF", "#B5BD00"),
    # --- Oakland/Las Vegas Raiders (code OAK, permanent) ---
    ("nfl_0022", 1996, "#A2AAAD", "#010101", "#FFFFFF"),
    ("nfl_0022", 2020, "#A2AAAD", "#010101", "#FFFFFF"),
    # --- Philadelphia Eagles ---
    ("nfl_0023", 1996, "#004851", "#101820", "#919D9D"),
    # --- San Diego/LA Chargers (code SD, permanent) ---
    ("nfl_0025", 1996, "#0C2340", "#FFB81C", "#FFFFFF"),
    ("nfl_0025", 2017, "#0C2340", "#FFB81C", "#FFFFFF"),
    # --- Seattle Seahawks ---
    ("nfl_0026", 1996, "#003087", "#00843D", "#A2AAAD"),
    ("nfl_0026", 2002, "#2D5980", "#091F2C", "#64A70B"),
    ("nfl_0026", 2009, "#213D5A", "#091F2C", "#43B02A"),
    # --- San Francisco 49ers ---
    ("nfl_0027", 1996, "#9B2743", "#B9975B", "#101820"),
    ("nfl_0027", 2002, "#9D2235", "#B9975B", "#010101"),
    ("nfl_0027", 2009, "#A6192E", "#B9975B", "#FFFFFF"),
    # --- St. Louis/LA Rams (code STL, permanent) ---
    ("nfl_0028", 1996, "#002D72", "#FFB81C", "#FFFFFF"),
    ("nfl_0028", 2000, "#041E42", "#AD841F", "#FFFFFF"),
    ("nfl_0028", 2002, "#0C2340", "#C6AA76", "#FFFFFF"),
    ("nfl_0028", 2016, "#0C2340", "#FFFFFF", "#C6AA76"),
    # --- Tampa Bay Buccaneers ---
    ("nfl_0029", 1996, "#FF8200", "#C8102E", "#FFFFFF"),
    ("nfl_0029", 1997, "#A6192E", "#696158", "#010101"),
    ("nfl_0029", 2014, "#C8102E", "#3D3935", "#B2B4B2"),
    # --- Houston Oilers -> Tennessee Oilers -> Tennessee Titans (code TEN) ---
    ("nfl_0012", 1996, "#418FDE", "#C8102E", "#FFFFFF"),
    ("nfl_0012", 1997, "#418FDE", "#C8102E", "#FFFFFF"),
    ("nfl_0012", 1999, "#0C2340", "#418FDE", "#FFFFFF"),
    ("nfl_0012", 2018, "#0C2340", "#418FDE", "#B2B4B2"),
